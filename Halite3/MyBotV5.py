...
# def get_mean_halite(input_game, at):
...
logging.info("top10_dropoff_options")
logging.info(best_dropoff_options)
reproduction_rate = 1.0
target_lock = {}
resource_dict = resource_graph(game)
# for pos, halite in resource_graph.items():

game.ready("TheDragonSlayer_v5")
...
while True:
    ...
    for ship in me.get_ships():
        ...
        if ship.is_full and ship.id not in target_lock:
            closest = inf
